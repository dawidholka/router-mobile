...
class BitmapDescriptorHelper{
  Future<BitmapDescriptor> getSvgAsset(BuildContext context, String assetName) async {
    ...
    double width = 24 * devicePixelRatio; // where 32 is your SVG's original width
    double height = 39 * devicePixelRatio; // same thing
